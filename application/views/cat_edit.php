            ...
            <div class="row clearfix">
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                    <div class="card">
                        ...
                        <div class="body">
                        <?php echo form_open('dashboard/update_cat'); ?>
                        <?php if($cate) {?>
                            <label for="se_title">Category Name</label>
                            <div class="form-group">
                                <div class="form-line">
                                    <input type="hidden" name="se_id" value="<?php echo $cate->se_id ?>">
                                    <input type="text" name="se_title" class="form-control" placeholder="Masukkan nama kategori" value="<?php echo $cate->se_title ?>">
                                </div>
                            </div>
                            <label for="se_desc">Description</label>
                            <div class="form-group">
                                <div class="form-line">
                                    <textarea rows="4" class="form-control no-resize" name="se_desc" placeholder="Masukkan Deskripsi yang diinginkan"><?php echo $cate->se_desc ?></textarea>
                                </div>
                            </div>
                        <?php } ?>
